...
--- Singleton ---
Singleton 1 ID: ylqsdk
Singleton 2 ID: ylqsdk
Same instance? true
...
--- Scoped ---
Scope 1 - Instance A ID: 38c8oc
Scope 1 - Instance B ID: 38c8oc
Same instance in scope? true
Scope 2 - Instance ID: mfjg6
Different from scope 1? true

--- Transient ---
Transient 1 ID: mr5w2r
Transient 2 ID: iazqrg
Same instance? false
*/
